    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          <h1 class="section-heading text-uppercase">Pet - Healths</h1>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-12">
          <form id="serviceForm" name="serviceHealths" novalidate="novalidate" method="POST" action="{{route('post.healths')}}">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <textarea class="form-control" id="complain" placeholder="Your Complain *" required="required" data-validation-required-message="Please enter a message."></textarea>
                  <p class="help-block text-danger"></p>
                </div>
                </div>
              <div class="col-md-6">
              ...
              <div class="col-lg-12 text-center">
                <div id="success"></div>
                <button id="sendHealthsOrder" class="btn btn-primary btn-xl text-uppercase" type="submit">Order Now</button>
              </div>
            </div>
          </form>
        </div>
